...
"use client";
// @ts-nocheck
// NOTE: This sidebar is deprecated - app uses groupedSidebar.tsx instead
...
// Unused - floating dock components no longer exist
...
import { FloatingDockItem } from '../ui/floatingDockItem';
import { FloatingDockDropdown } from '../ui/floatingDockDropdown';
        ...
        >
            ...
            <nav className="flex-1 flex flex-col space-y-6 px-4 overflow-y-auto no-scrollbar">
                ...
                <RoleBasedWrapper allowedRoles={['tenant_admin', 'staff', 'doctor', 'agent']}>
                    ...
                    <FloatingDockItem isExpanded={isExpanded} isDarkMode={isDarkMode} icon={Database} label="Knowledge" route="/knowledge?tab=data-sources" onClick={() => handleActiveTab('/knowledge?tab=data-sources')} />
                </RoleBasedWrapper>
