...
const PopoverContent = React.forwardRef<
    ...
    React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Content> & { isDarkMode?: boolean }
>(({ className, align = "center", sideOffset = 4, isDarkMode, ...props }, ref) => (
    <PopoverPrimitive.Portal>
        <PopoverPrimitive.Content
            ...
            className={cn(
                ...
                isDarkMode ? "bg-[#09090b] text-white border-white/10" : "bg-white text-slate-950 border-slate-200",
                className
            )}
            {...props}
        />
