                    ...
                    <div className="flex items-center justify-end space-x-3">
                        <button
                            ...
                            className={cn(
                                ...
                                isDarkMode
                                    ? ` ${isView ? 'bg-red-500 border-transparent text-white hover:bg-red-600' : 'border-white/10 text-white/70 hover:bg-white/5 hover:text-white'}`
                        ...
                        {isEdit && (
                            <button
                                ...
                                className={cn(
                                    "px-5 py-2.5 rounded-xl text-sm font-semibold text-white transition-all shadow-lg flex items-center space-x-2",
                                    isDarkMode
