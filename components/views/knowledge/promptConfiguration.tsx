                                        ...
                                        <div className="flex items-center space-x-2">
                                            <label className="relative inline-flex items-center cursor-pointer">
                                                <input
                                                    ...
                                                    disabled={promptsData?.data?.prompts?.every((prompt: any) => prompt?.is_active == 0) ? false : prompt.is_active == 1 ? false : true}
            ...
            <GlassCard isDarkMode={isDarkMode} className="p-6">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className={cn("text-xs mt-1", isDarkMode ? 'text-white/50' : 'text-slate-500')}>
                            Prompts that have been deleted.
                        </p>
                    </div>
                </div>
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    ...
                                    {user?.role == "tenant_admin" && <ActionMenu
                                        ...
                                        isRestore={true}
                                        onPermanentDelete={() => handlePermanentDeleteClick(prompt, "prompt", true)}
                                        onRestore={() => handleRestore(prompt, "prompt")}
                                    />}
                                </div>
                            </div>
                        ))
