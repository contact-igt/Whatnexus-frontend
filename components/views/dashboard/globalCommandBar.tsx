        ...
        <div className="rounded-xl border transition-all" style={{ background: isDarkMode ? '#09090b' : '#ffffff', borderColor: isDarkMode ? '#27272a' : '#e4e4e7' }}>
            <div className="px-5 py-3.5 flex items-center justify-between gap-3 flex-wrap">
                ...
                <div className="flex items-center gap-2.5">
                    ...
                    {/* Alert bell */}
                    <button onClick={() => { dispatch(clearWhatsAppUnreadCount()); router.push('/shared-inbox/live-chats'); }}
                        ...
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" style={{ color: unreadCount > 0 ? '#f43f5e' : t.secondary }} aria-hidden="true">
