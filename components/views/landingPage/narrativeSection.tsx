...
export const NarrativeSection = () => {
    return (
        <section className="py-20 md:py-24 bg-[#0D0D0F] border-y border-white/5 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h3 className="text-2xl sm:text-3xl md:text-5xl font-black text-white leading-[1.2] md:leading-tight mb-8">
