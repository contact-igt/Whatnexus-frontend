    ...
    return (
        <section className="py-20 md:py-32 px-6">
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="grid md:grid-cols-2 gap-0 rounded-3xl md:rounded-[40px] overflow-hidden border border-white/10 shadow-2xl">
                    <div className="p-6 sm:p-10 md:p-12 bg-white/[0.02]">
                    ...
                    <div className="p-6 sm:p-10 md:p-12 bg-emerald-500/10 border-t md:border-t-0 md:border-l border-white/10 relative overflow-hidden">
