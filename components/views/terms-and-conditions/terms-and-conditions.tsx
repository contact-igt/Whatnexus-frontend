            ...
            <main className="max-w-8xl mx-auto px-6 sm:px-10 pt-36 pb-28">
                ...
                <section id="data-privacy">
                    ...
                    <ul className={cn("mt-2 mb-5 space-y-2 text-sm leading-relaxed", body)}>
                        ...
                        <Bullet><B d={D}>7.3 Privacy Policy.</B> Your use of the Platform is also governed by our Privacy Policy available at: <A href="/privacy-policy" d={D}>https://whatsnexus.com/privacy-policy</A>.</Bullet>
