...
export default function ExpiredScreen({ email = "" }: ExpiredScreenProps) {
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <div className="flex justify-center mb-6">
                        ...
                        >
                            <RotateCcw
                                className={cn("w-10 h-10", isDarkMode ? "text-red-400" : "text-red-600")}
                                strokeWidth={2.5}
                            />
                        </div>
                    </div>
                    ...
                    {/* Title */}
                    <h1 className={cn("text-2xl font-bold mb-3", isDarkMode ? "text-white" : "text-slate-900")}>
                        Link Expired
                    </h1>

                    {/* Message */}
                    <p className={cn("text-sm leading-relaxed mb-6 max-w-sm mx-auto", isDarkMode ? "text-slate-400" : "text-slate-600")}>
                    ...
                    <div className={cn(
                        ...
                        isDarkMode ? "bg-slate-800/50 border-slate-700/50" : "bg-slate-50 border-slate-200/50"
                    )}>
                        <div className="flex items-start gap-3">
                            <Info className={cn("w-5 h-5 shrink-0 mt-0.5", isDarkMode ? "text-slate-400" : "text-slate-600")} />
                            <div>
                                <h3 className={cn("text-sm font-semibold mb-1", isDarkMode ? "text-slate-300" : "text-slate-700")}>
                                    What happens next?
                                </h3>
                    ...
                    <div className="space-y-3">
                        {/* Request New Link — not yet implemented */}
