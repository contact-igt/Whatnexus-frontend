...
interface AlreadyRejectedScreenProps {
    organizationName?: string;
}

export default function AlreadyRejectedScreen({
    organizationName = "Invictus Global Tech",
}: AlreadyRejectedScreenProps) {
        ...
        <div className="w-full max-w-md mx-auto animate-in fade-in slide-in-from-bottom-6 duration-500">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    >
                        Invitation Previously Declined
                    </h1>
                    ...
                    >
                        ...
                        <span className="font-semibold">{organizationName}</span> was already declined
                    </p>
                    ...
                    >
                        ...
                        <ul className="space-y-2">
                            ...
                            >
                                ...
                                <span>Contact the organization administrator for a new invitation</span>
                            </li>
                            <li
                                className={cn(
                                    "text-sm flex items-start gap-2",
