...
import { IndustryModuleMappingView } from "@/components/views/moduleAccessManagement/IndustryModuleMappingView";

export default function IndustryModuleMappingPage() {
  return (
    <RoleBasedWrapper
