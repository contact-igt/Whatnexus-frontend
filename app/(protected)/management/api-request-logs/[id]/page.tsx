...
import { ApiRequestLogDetailsView } from "@/components/views/apiRequestLogs/apiRequestLogDetailsView";

export default function ApiRequestLogDetailsPage() {
    return (
        <RoleBasedWrapper
